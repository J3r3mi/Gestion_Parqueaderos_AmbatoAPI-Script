...
La solución incluye una API REST para la gestión de parqueaderos privados en la ciudad de Ambato. El backend fue desarrollado con **ASP.NET Core, C# y Entity Framework Core**, utilizando **MySQL** como sistema gestor de base de datos.
